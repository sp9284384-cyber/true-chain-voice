      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-card bg-ink px-4 py-2.5 text-sm font-medium text-white hover:opacity-90 disabled:opacity-60"
          >
