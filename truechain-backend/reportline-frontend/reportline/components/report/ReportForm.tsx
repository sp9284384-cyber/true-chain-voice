...
export function ReportForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const message =
        err instanceof ApiError ? "Something went wrong submitting your report. Please try again." : "Network error — please try again.";
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-card bg-ink px-4 py-3 text-sm font-medium text-white transition-opacity hover:opacity-90 disabled:opacity-60"
      >
